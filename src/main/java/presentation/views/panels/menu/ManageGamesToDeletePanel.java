...
import presentation.views.panels.menu.components.ManageGamesToDeleteTable;
...
/**
 * Class used to show a JTable with the previous games, in order to delete one of them
 */
public class ManageGamesToDeletePanel extends MenuPanel{
    /**
     ...
     */
    public ManageGamesToDeletePanel() {
        super("files/home_background.png", PanelKey.DELETE_GAME);
    ...
    private void configureTable () {
        ...
        ManageGamesToDeleteTable manageExistingGamesTable = new ManageGamesToDeleteTable();
