...
/**
 * Class used to show that the game has finished and the user has won
 */

public class VictoryPanel extends MenuPanel {
    ...
    public void attachListener(EventListener listener) {
        continuar.addActionListener((ActionListener) listener);
    }
    ...
    public void detachListener(EventListener listener) {
        continuar.removeActionListener((ActionListener) listener);
    }
