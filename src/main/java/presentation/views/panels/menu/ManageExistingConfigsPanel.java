...
/**
 * Class used to show a JTable with the configuration of the previous games, in order to choose one of them
 */

public class ManageExistingConfigsPanel extends MenuPanel {
    /**
     ...
     */
    public ManageExistingConfigsPanel() {
        super("files/home_background.png", PanelKey.COPY_CONFIGS);
    ...
    private void configureTable () {
        ...
        ManageExistingConfigsTable manageExistingGamesTable = new ManageExistingConfigsTable();
